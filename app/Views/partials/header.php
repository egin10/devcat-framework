...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo new Asset('devcat.png'); ?>" type="image/x-icon">

    <!-- CSS -->
    <link rel="stylesheet" href="<?php echo new Css('bootstrap-3.3.7/css/bootstrap.min.css'); ?>">
    <link rel="stylesheet" href="<?php echo new Css('bootstrap-3.3.7/css/bootstrap-theme.min.css'); ?>">
